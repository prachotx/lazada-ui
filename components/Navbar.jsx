            ...
            <Wrapper>
                <div className="flex items-center justify-between h-[75px]">
                    ...
                    <div className="flex items-center h-[45px]">
                        <input className="bg-[#e7e8ec] text-[#999] h-full outline-none text-[14px] pl-[20px] w-[650px] rounded-l" type="text" placeholder="Search in Lazada" />
                    ...
                    <div className="text-[33px] text-blue-950 cursor-pointer"><FiShoppingCart /></div>
